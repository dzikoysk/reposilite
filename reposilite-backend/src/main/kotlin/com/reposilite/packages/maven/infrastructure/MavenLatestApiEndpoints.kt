...
internal class MavenLatestApiEndpoints(
    ...
    private fun <T> resolveLatestArtifact(context: ContextDsl<*>, accessToken: AccessTokenDto?, mavenRepository: MavenRepository, handler: com.reposilite.packages.maven.MatchedVersionHandler<T>): Result<T, ErrorResponse> =
