...
import com.reposilite.packages.maven.StoragePolicy
import com.reposilite.packages.maven.MavenRepositoryVisibility
...
data class RepositorySettings(
    ...
    val visibility: MavenRepositoryVisibility = PUBLIC,
