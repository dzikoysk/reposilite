...
class SharedConfigurationFacade(private val schemaGenerator: SchemaGenerator) : Facade {
    ...
    fun updateSharedSettings(content: String): List<Pair<SharedSettingsReference<*>, Result<SharedSettings, out Exception>>> =
        Result.attempt { DEFAULT_OBJECT_MAPPER.readTree(content) }
