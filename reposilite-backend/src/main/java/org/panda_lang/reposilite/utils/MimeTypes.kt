...
object MimeTypes {
    ...
    val MIME_PLAIN = "text/plain"
    val MIME_HTML = "text/html"
    val MIME_XML = "text/xml"
    val MIME_OCTET_STREAM = "application/octet-stream"
    val MIME_JAVASCRIPT = "application/javascript"
    ...
    fun getMimeType(name: String, defaultTemplate: String): String {
