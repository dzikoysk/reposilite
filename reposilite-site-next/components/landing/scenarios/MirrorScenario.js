...
const mirrorScenario = {
  ...
  flow: [
    ...
    { id: 'central', data: { label: <Text>Maven Central</Text> }, position: { x: 155, y: 300}, sourcePosition: 'top', targetPosition: 'top' },
    { id: 'private', data: { label: <Text>Private<br/>Repository</Text> }, position: { x: 0, y: 250}, sourcePosition: 'top', targetPosition: 'top' },
    { id: 'local', data: { label: <LocalRepository /> }, position: { x: 300, y: 250}, sourcePosition: 'top', targetPosition: 'top' },
