...
const features = [
  ...
  feature('Docker 🐋', <Text>Available docker images <Link color={'purple.400'} href="https://hub.docker.com/r/dzikoysk/reposilite">hub.docker.com/r/dzikoysk/reposilite</Link></Text>),
